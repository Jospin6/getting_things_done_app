...
export const AddProject = (props) => {
    ...
    const handleInputChange = (e) => dispatch(addProject({
    ...
    return <div className="w-[300px] h-[200px] mt-[150px] bg-white rounded-lg m-auto">
        <div className="rounded-t-lg border-b-[1px] border-gray-200 pb-2">
            <div className="w-full h-[40px] text-black rounded-t-lg text-center leading-[40px] semi-bold text-[20px] relative">
        ...
        <div className="w-full p-2">
            ...
            rounded-lg pl-2 outline-none" placeholder="Name your project" 
